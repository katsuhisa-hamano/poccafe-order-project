...
const app = {
    ...
    confirmAddToCart(itemId, itemName) {
        ...
        this.state.payload.customer_name = 'おめこ' //this.state.isAdmin ? this.state.adminCustomers.find(item => item.square_customer_id === targetCustomerId).name : this.state.user.name;
        this.state.payload.customer_email = this.state.isAdmin ? this.state.adminCustomers.find(item => item.square_customer_id === targetCustomerId).email : this.state.user.email;
