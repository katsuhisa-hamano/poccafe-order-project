      ...
      if (squareItemId) {
        try {
          ...
          const result = {
            ...
            // オプション（トッピングなど）
            max_selected_modifiers: item.modifier_list_info[0].max_selected_modifiers === -1 ? related.modifier_list_data.max_selected_modifiers : item.modifier_list_info[0].max_selected_modifiers,
            options: related
